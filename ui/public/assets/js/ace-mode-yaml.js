      ...
      s = function () {
        (this.$rules = {
          start: [
            ...
            { token: ["meta.tag", "keyword"], regex: /^(\s*\w[^\s:]*?)(:(?=\s|$))/ },
            { token: ["meta.tag", "keyword"], regex: /(\w[^\s:]*?)(\s*:(?=\s|$))/ },
            ...
            { token: "string", regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' },
            {
              ...
              onMatch: function (e, t, n, r) {
                ...
                return (
                  s ? ((i += s - 1), (this.next = "mlString")) : (this.next = "mlStringPre"),
                    n.length ? ((n[0] = this.next), (n[1] = i)) : (n.push(this.next), n.push(i)),
                    this.token
                );
              },
              next: "mlString",
          ...
          mlString: [
            { token: "indent", regex: /^ *$/ },
            {
              ...
              onMatch: function (e, t, n) {
                var r = n[1];
                return (
                  r >= e.length ? ((this.next = "start"), n.splice(0)) : (this.next = "mlString"),
                    this.token
                );
              },
              next: "mlString",
        ...
        function () {
          (this.lineCommentStart = ["#"]),
            ...
            (this.createWorker = function (e) {
              var t = new a(["ace"], "ace/mode/yaml_worker", "YamlWorker");
              return (
