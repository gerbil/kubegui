...
export const K8S_FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  // common top-level details
  'apiVersion':                           'Kubernetes API group and version used for this object.',
  'kind':                                 'Kubernetes resource kind for this object.',
  'type':                                 'Resource-specific type, such as a Secret type or Event type.',
  'data':                                 'Resource payload data stored as key-value entries.',
  'binaryData':                           'Binary payload data stored as base64-encoded key-value entries.',
  'stringData':                           'Write-only Secret string data converted by the API server into data.',
  'immutable':                            'When true, this resource data cannot be changed after creation.',
  'reason':                               'Short machine-readable reason for the latest reported event or state.',
  'message':                              'Human-readable message describing the latest event or state.',
  'count':                                'Number of times this event or condition has been observed.',
  'action':                               'Action taken or attempted by the reporting component.',
  'eventTime':                            'Timestamp for when the event was observed.',
  'firstTimestamp':                       'Time when this event was first observed.',
  'lastTimestamp':                        'Time when this event was most recently observed.',
  'reportingComponent':                   'Component that reported this event.',
  'reportingInstance':                    'Instance of the component that reported this event.',
  'source':                               'Legacy event source that reported this event.',
  'involvedObject':                       'Object that this event is about.',
  'related':                              'Secondary object related to this event.',
  // spec – workloads
